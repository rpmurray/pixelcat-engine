...
class ImageResourceImpl extends ResourceImpl implements ImageResource {
    ...
    private static ResourceFileLoader resourceFileLoader = new ResourceFileLoaderImpl();

    ImageResourceImpl(Integer x, Integer y, String file, Integer imageX1, Integer imageY1, Integer imageX2, Integer imageY2) {
        super(x, y, imageX2 - imageX1, imageY2 - imageY1);
        this.file = file;
    ...
    public void loadImage() throws GameException {
        try {
            this.image = resourceFileLoader.loadImage(file);
        } catch (Exception e) {
