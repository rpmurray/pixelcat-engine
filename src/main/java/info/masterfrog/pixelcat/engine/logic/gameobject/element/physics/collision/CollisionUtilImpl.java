...
import info.masterfrog.pixelcat.engine.logic.resource.CollidableResource;
import info.masterfrog.pixelcat.engine.logic.resource.CollisionMaskResource;
import info.masterfrog.pixelcat.engine.logic.resource.Resource;
import info.masterfrog.pixelcat.engine.logic.resource.SpriteUtil;
...
class CollisionUtilImpl implements CollisionUtil {
    ...
    private Rectangle getResourceBounds(GameObject gameObject) throws TransientGameException {
        ...
        Point position = gameObject.getFeature(RenderingLibrary.class).getCurrent(gameObject.getCanvas()).getCanvasNormalizedPosition();
